...
function AboutPage() {
  ...
  const timeline = [
    { year: "2011", event: { en: "Hospital started as a small clinic in Bishoftu (Debre Zeit) serving the local community.",    am: "ሆስፒታሉ በቢሾፍቱ (ደብረ ዘይት) እንደ ትንሽ ክሊኒክ ተጀመረ።",         or: "Hospitaalli Bishooftuu (Debre Zeit) keessatti akka kilinika xiqqaatti eegale." } },
    { year: "2014", event: { en: "Expanded services with additional medical equipment and specialist consultations.",            am: "ተጨማሪ የህክምና መሳሪያዎች እና ስፔሻሊስት ምክክሮች ተጨምረዋል።",               or: "Meeshaalee yaalaa dabalataa fi mari'annoo ogeessotaa waliin tajaajila babal'ate." } },
    ...
    { year: "2020", event: { en: "Officially became a primary hospital in Bishoftu with expanded capabilities and specialized departments.",             am: "በይፋ በቢሾፍቱ ወደ ፕራይመሪ ሆስፒታል ተለወጠ ከተስፋፋ አቅሞች እና ልዩ ክፍሎች ጋር።",                         or: "Ifaan Bishooftuu keessatti hospitaala sadarkaa tokkoffaatti jijjiirame dandeettii babal'aatee fi kutaalee addaa waliin." } },
    { year: "2023", event: { en: "Launched 24/7 emergency department with ambulance service in Bishoftu.",          am: "በቢሾፍቱ 24/7 የአደጋ ክፍል ከአምቡላንስ አገልግሎት ጋር ተጀምሯል।",                or: "Bishooftuu keessatti kutaan ariifachiisaa 24/7 tajaajila ambulaansii waliin eegale." } },
    { year: "2025", event: { en: "Serving tens of thousands of patients annually across Bishoftu and surrounding regions.",                   am: "በቢሾፍቱና በአካባቢው ክልሎች በዓመት ብዙ ሺ ታካሚዎችን እያገለገሉ ነው።",                             or: "Bishooftuu fi naannoo isaa keessatti dhukkubsattoota kuma hedduuf tajaajila waggaa kennaa jira." } },
  ];
