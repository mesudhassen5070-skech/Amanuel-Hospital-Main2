  ...
  head: () => ({
    meta: [
      ...
      { title: "Dr. Amanuel Hospital — Amanuel Hospital Bishoftu" },
      {
        name: "description",
        content:
          "Official website of Amanuel Hospital in Bishoftu. Providing quality healthcare, emergency services, and medical care at dr amanuel hospital.",
      },
      {
        name: "keywords",
        content: "amanuel hospital, amanuel hospital bishoftu, dr amanuel hospital",
      },
      { name: "author", content: "Dr. Amanuel Hospital" },
      { property: "og:title", content: "Dr. Amanuel Hospital — Amanuel Hospital Bishoftu" },
      {
        property: "og:description",
        content: "Providing 24/7 quality healthcare services in Bishoftu, Ethiopia.",
      },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://amanuelhospital.com.et/" },
...
function RootShell({ children }: { children: ReactNode }) {
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body suppressHydrationWarning className="bg-white dark:bg-slate-900 text-slate-900 dark:text-white transition-colors">
        {children}
        <Scripts />
      </body>
    </html>
