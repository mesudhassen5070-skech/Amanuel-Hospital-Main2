...
export const translatedDepartments = {
  en: [
    ...
    { name: "Surgery",                 description: "General and specialized surgical procedures in modern theaters. 24/7 emergency surgical services available." },
    { name: "Pediatrics",              description: "Dedicated child healthcare from newborns to adolescents." },
    { name: "Obstetrics & Gynecology", description: "Women's health, antenatal care and safe delivery services. 24/7 emergency deliveries and maternal care available." },
    { name: "Emergency Medicine",      description: "24/7 rapid response emergency and trauma care available round-the-clock." },
    ...
    { name: "Orthopedics",             description: "Bone, joint and musculoskeletal treatment and rehabilitation. 24/7 emergency orthopedic surgical services available." },
    { name: "ENT (Ear, Nose & Throat)", description: "Specialized ear, nose and throat procedures including tonsillectomy and advanced ENT care." },
  ...
  am: [
    ...
    { name: "ቀዶ ጥገና",                  description: "ዘመናዊ ቀዶ ጥገና ቤቶች ውስጥ አጠቃላይ እና ልዩ ቀዶ ጥገና አገልግሎቶች። የ24/7 የአደጋ ጊዜ የቀዶ ጥገና አገልግሎቶች ይገኛሉ።" },
    { name: "ሕፃናት ሕክምና",               description: "ከጨቅላ ሕፃናት እስከ ጉርምስና ዕድሜ ለሚደርሱ ሕፃናት ልዩ ጤና አገልግሎት።" },
    { name: "የሴቶች ጤና",                 description: "የሴቶች ጤና አገልግሎቶች፣ ቅድመ ወሊድ እንክብካቤ እና ደህና ወሊድ። የ24/7 የአደጋ ጊዜ ወሊዶች እና የእናት እንክብካቤ ይገኛሉ።" },
    { name: "አደጋ ጊዜ ሕክምና",            description: "24/7 ፈጣን ምላሽ አደጋ ጊዜ እና የቁስለት ሕክምና በየጊዜው ይገኛል።" },
    ...
    { name: "የአጥንት ሕክምና",             description: "የአጥንት፣ መገጣጠሚያ እና ጡንቻ አወቃቀር ሕክምና እና ማገገሚያ። የ24/7 የአደጋ ጊዜ የአጥንት ቀዶ ጥገና አገልግሎቶች ይገኛሉ።" },
    { name: "የጆሮ፣ አፍንጫ እና ጉሮሮ (ENT)",  description: "ልዩ የጆሮ፣ አፍንጫ እና ጉሮሮ ሂደቶች ቶንሲሌክቶሚ እና የላቁ ENT እንክብካቤን ጨምሮ።" },
  ...
  or: [
    ...
    { name: "Qoricha Mukkeen",          description: "Hojii qoricha waliigalaa fi addaa manneen qoricha ammayyaa keessatti. Tajaajila qoricha ariifachiisaa 24/7 ni argama." },
    { name: "Fayyaa Daa'immanii",       description: "Kunuunsa fayyaa daa'imaa addaa daa'ima haaraa hanga dargaggeessa." },
    { name: "Fayyaa Dubartii",          description: "Tajaajila fayyaa dubartii, kunuunsa ulfaa fi da'uumsa nagaa. Da'uumsa ariifachiisaa fi kunuunsa haadholii 24/7 ni argama." },
    { name: "Qoricha Ariifachiisaa",    description: "Deebii ariifachiisaa 24/7 fi kunuunsa madaa yeroo hunda ni argama." },
    ...
    { name: "Qoricha Lafee",            description: "Yaalii fi deebi'uu fayyaa lafee, maqaa fi harka-miilaa. Tajaajila qoricha lafee ariifachiisaa 24/7 ni argama." },
    { name: "ENT (Gurra, Funyaanii & Laaguu)", description: "Adeemsa addaa gurra, funyaanii fi laaguu tonsillectomy fi kunuunsa ENT olaanaa dabalatee." },
...
export const translatedServices = {
  en: [
    { id: "emergency-services",    title: "Emergency Services",         description: "24-hour emergency medical services with rapid response and critical care capabilities.", detail: "Our emergency department operates 24/7 with trained emergency physicians, advanced life support equipment, and ambulance coordination for immediate medical attention. Emergency surgeries, deliveries, and critical care available round-the-clock." },
    { id: "medical-services",      title: "Medical Services",           description: "Comprehensive internal medicine and general practice for diagnosis and treatment.",      detail: "Expert medical care including general consultations, chronic disease management, preventive health check-ups, and specialized diagnostic services." },
    { id: "surgical-services",     title: "Surgical Services",          description: "24-hour surgical capabilities with modern operating theaters and experienced surgeons.",  detail: "Advanced surgical procedures including general surgery, orthopedic operations, and emergency surgeries performed in state-of-the-art operating rooms. 24/7 emergency surgical services available round-the-clock." },
    { id: "pediatric-care",        title: "Pediatric Care",             description: "Specialized healthcare for infants, children, and adolescents with compassionate experts.", detail: "Complete pediatric services including well-child visits, immunizations, growth monitoring, and treatment of childhood illnesses in a child-friendly environment." },
    { id: "gynecology-obstetrics", title: "Gynecology & Obstetrics",    description: "Women's health services including prenatal care, safe delivery, and gynecological treatment.", detail: "Comprehensive maternal and women's healthcare with antenatal clinics, delivery services, caesarean sections, family planning, and gynecological consultations. 24/7 emergency deliveries and critical maternal care available round-the-clock." },
    { id: "ent-services",          title: "ENT Services",               description: "Specialized ear, nose, and throat procedures by experienced ENT specialists.",          detail: "Comprehensive ENT care including tonsillectomy, adenoidectomy, sinus treatments, ear infections, hearing evaluations, and advanced diagnostic procedures for ear, nose, and throat conditions." },
    { id: "orthopedic-services",   title: "Orthopedic Surgical Services", description: "24-hour orthopedic surgery and trauma care for bone, joint, and musculoskeletal injuries.", detail: "Comprehensive orthopedic surgical care including fracture repairs, joint surgeries, sports injuries, and trauma management. 24/7 emergency orthopedic surgical services available round-the-clock for urgent bone and joint injuries." },
  ],
  am: [
    { id: "emergency-services",    title: "የአደጋ ጊዜ አገልግሎት",         description: "24 ሰዓት የአደጋ ጊዜ የህክምና አገልግሎት ከፈጣን ምላሽ እና ከባድ ህክምና አቅም ጋር።",      detail: "የአደጋ ጊዜ ክፍላችን 24/7 ሰልጠነው ባሉ የአደጋ ጊዜ ሐኪሞች፣ የላቁ የህይወት ድጋፍ መሣሪያዎች እና የአምቡላንስ ቅንጅት ለአፋጣኝ የህክምና እርዳታ ይሰራል። የአደጋ ጊዜ ቀዶ ጥገናዎች፣ ወሊዶች እና ከባድ እንክብካቤ በ24/7 ይገኛል።" },
    { id: "medical-services",      title: "የህክምና አገልግሎቶች",          description: "ሙሉ የውስጥ ህክምና እና አጠቃላይ ልምምድ ለምርመራ እና ህክምና።",                detail: "ባለሙያ የህክምና እንክብካቤ አጠቃላይ ምክክሮች፣ የሥር ሰደድ በሽታ አስተዳደር፣ መከላከያ የጤና ምርመራዎች እና ልዩ የምርመራ አገልግሎቶችን ያካትታል።" },
    { id: "surgical-services",     title: "የቀዶ ጥገና አገልግሎቶች",       description: "24 ሰዓት የቀዶ ጥገና አቅም ከዘመናዊ የቀዶ ጥገና መድረኮች እና ልምድ ባላቸው ቀዶ ሐኪሞች ጋር።", detail: "የላቁ የቀዶ ጥገና ሂደቶች አጠቃላይ ቀዶ ጥገና፣ የአጥንት ስራዎች እና የአደጋ ጊዜ ቀዶ ጥገናዎችን በጣም ዘመናዊ የቀዶ ጥገና ክፍሎች ውስጥ ያካትታል። የ24/7 የአደጋ ጊዜ የቀዶ ጥገና አገልግሎቶች በየጊዜው ይገኛሉ።" },
    { id: "pediatric-care",        title: "የህፃናት እንክብካቤ",          description: "ለህፃናት፣ ህፃናት እና ለወጣቶች ልዩ የጤና እንክብካቤ ከሰብዓዊ ባለሙያዎች ጋር።",       detail: "ሙሉ የህፃናት አገልግሎቶች በጤና-ህፃን ጉብኝቶች፣ ክትባቶች፣ የእድገት ክትትል እና የህፃናት በሽታዎች ህክምና በህፃናት ተስማሚ አካባቢ።" },
    { id: "gynecology-obstetrics", title: "የሴቶች ጤናና ወሊድ",          description: "የሴቶች ጤና አገልግሎቶች የቅድመ ወሊድ እንክብካቤ፣ ደህንነቱ የተጠበቀ ወሊድ እና የሴቶች ህክምናን ጨምሮ።", detail: "ሙሉ የእናቶች እና የሴቶች ጤና አገልግሎት ከቅድመ ወሊድ ክሊኒኮች፣ የወሊድ አገልግሎቶች፣ የቄሳሪያን ክፍሎች፣ የቤተሰብ ምጣኔ እና የሴቶች ምክክሮች ጋር። የ24/7 የአደጋ ጊዜ ወሊዶች እና ከባድ የእናት እንክብካቤ በየጊዜው ይገኛሉ።" },
    { id: "ent-services",          title: "የጆሮ፣ አፍንጫ እና ጉሮሮ አገልግሎት", description: "በልምድ ባላቸው ENT ስፔሻሊስቶች ልዩ የጆሮ፣ አፍንጫ እና ጉሮሮ ሂደቶች።",            detail: "ሙሉ ENT እንክብካቤ ቶንሲሌክቶሚ፣ አዴኖይዴክቶሚ፣ የሳይነስ ህክምናዎች፣ የጆሮ ኢንፌክሽኖች፣ የመስማት ግምገማዎች እና የላቁ የምርመራ ሂደቶችን ያካትታል።" },
    { id: "orthopedic-services",   title: "የአጥንት ቀዶ ጥገና አገልግሎቶች",  description: "24 ሰዓት የአጥንት ቀዶ ጥገና እና ድንገተኛ እንክብካቤ ለአጥንት፣ መገጣጠሚያ እና የጡንቻ ጉዳቶች።", detail: "ሙሉ የአጥንት ቀዶ ጥገና እንክብካቤ የስብራት ጥገናዎች፣ የመገጣጠሚያ ቀዶ ጥገናዎች፣ የስፖርት ጉዳቶች እና የአደጋ ጊዜ አስተዳደርን ያካትታል። የ24/7 የአደጋ ጊዜ የአጥንት ቀዶ ጥገና አገልግሎቶች ለአጣዳፊ አጥንት እና መገጣጠሚያ ጉዳቶች በየጊዜው ይገኛሉ።" },
  ],
  or: [
    { id: "emergency-services",    title: "Tajaajila Ariifachiisaa",    description: "Tajaajila fayyaa ariifachiisaa sa'aatii 24 deebii ariifataa fi dandeettii kunuunsa cimaa waliin.",    detail: "Kutaan ariifachiisaa keenya 24/7 doktarota ariifachiisaa leenjifaman, meeshaalee deeggarsa jireenyaa olaanaa fi koordineeshiinii ambulaansii xiyyeeffannoo yaalaa ariifataaf hojjeta. Qoricha ariifachiisaa, da'uumsa fi kunuunsa cimaa 24/7 ni argama." },
    { id: "medical-services",      title: "Tajaajila Yaalii",           description: "Qoricha keessaa guutuu fi shaakala waliigalaa qorannoo fi yaalaaf.",                                   detail: "Kunuunsa yaalaa ogeessaa mari'annoo waliigalaa, bulchiinsa dhukkuba ture, qorannoo fayyaa ittisaa fi tajaajila qorannoo addaa of keessaa qaba." },
    { id: "surgical-services",     title: "Tajaajila Qoricha",          description: "Dandeettii qoricha sa'aatii 24 manneen qoricha ammayyaa fi hakiimonni muuxannoo qaban waliin.",        detail: "Adeemsa qoricha olaanaa qoricha waliigalaa, hojii lafee fi qoricha ariifachiisaa kutaalee qoricha teknolojii olaanaatiin raawwatame of keessaa qaba. Tajaajila qoricha ariifachiisaa 24/7 yeroo hunda ni argama." },
    { id: "pediatric-care",        title: "Kunuunsa Daa'immanii",       description: "Tajaajila fayyaa addaa daa'imman, ijoollee fi dargaggootaaf ogeessota gaddaa qaban waliin.",         detail: "Tajaajila daa'immanii guutuu daawwannaa daa'ima-fayyaa, talaalii, hordoffii guddinaa fi yaalii dhukkuboota ijoollee naannoo daa'imman-mijaawaa keessatti." },
    { id: "gynecology-obstetrics", title: "Fayyaa Dubartii fi Da'uumsa", description: "Tajaajila fayyaa dubartootaa kunuunsa ulfaa, da'uumsa nagaa fi yaalii dubartootaa of keessaa qaba.",    detail: "Kunuunsa haadholii fi dubartootaa guutuu kilinikaalee ulfaa, tajaajila da'umsaa, kutaalee siizariyaanii, karoora maatii fi mari'annoo dubartootaa waliin. Da'uumsa ariifachiisaa fi kunuunsa haadholii cimaa 24/7 yeroo hunda ni argama." },
    { id: "ent-services",          title: "Tajaajila Gurra, Funyaanii fi Laaguu", description: "Adeemsa addaa gurra, funyaanii fi laaguu ogeessota ENT muuxannoo qaban irraa.",                      detail: "Kunuunsa ENT guutuu tonsillectomy, adenoidectomy, yaalii sinus, dhukkuba gurra, madaalii dhaggeeffannaa fi adeemsa qorannoo olaanaa haalota gurra, funyaanii fi laaguu of keessaa qaba." },
    { id: "orthopedic-services",   title: "Tajaajila Qoricha Lafee",    description: "Qoricha lafee sa'aatii 24 fi kunuunsa ariifachiisaa miidhaa lafee, walqabduu fi foon-lafeetti.",    detail: "Kunuunsa qoricha lafee guutuu suphaa lafee sirreessuu, qoricha walqabduu, miidhaa ispoortii fi bulchiinsa ariifachiisaa of keessaa qaba. Tajaajila qoricha lafee ariifachiisaa 24/7 miidhaa lafee fi walqabduu ariifataa 24/7 ni argama." },
  ],
};
